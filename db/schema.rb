...
ActiveRecord::Schema.define(version: 2020_12_22_215506) do
  ...
  create_table "campaign_quota", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "campaign_qualifications_count"
  ...
  add_foreign_key "campaign_qualifications", "campaign_quota", column: "campaign_quota_id"
  add_foreign_key "campaign_quota", "campaigns"
end
